...
function saveData() {
  ...
  if (editId == undefined) {
    ...
    // var secondContent = `
    //   <p class="question-demo" id="question-demo ${editId}"></p>
    //   <button class="display-answer-button" onclick="displayAnswer('${firstCard.firstAnswer}', ${editId})">
    //     Show/Hide Answer
    //   </button>
    //   <p class="answer-demo display-answer ${editId}" id="answer-demo ${editId}"></p>
    //   <div class="buttons">
    //     <button class="edit-button" onclick="editFunction('${firstCard.firstQuestion}',
    //     '${firstCard.firstAnswer}',${editId})">EDIT</button>
    //     <button class="delete-button" onclick="deleteFunction(${editId})">DELETE</button>
    //   </div>
    // `;
